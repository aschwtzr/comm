...
test('pluralizeAndTrim', () => {
  expect(pluralizeAndTrim([], 10)).toBe('');
  expect(pluralizeAndTrim(['a'], 10)).toBe('a');
  expect(pluralizeAndTrim(['a', 'b'], 10)).toBe('a and b');

  expect(pluralizeAndTrim(['a', 'b', 'c'], 10)).toBe('3 users');
  expect(pluralizeAndTrim(['a', 'b', 'c'], 12)).toBe('a, b, and c');

  expect(pluralizeAndTrim(['a', 'b', 'c', 'd'], 10)).toBe('4 users');
  expect(pluralizeAndTrim(['a', 'b', 'c', 'd'], 20)).toBe('a, b, and 2 others');
  ...
  expect(pluralizeAndTrim(['cat', 'dog', 'sheep'], 1000)).toBe(
    'cat, dog, and sheep',
  );
});
