...
To make the development and testing process easier you can run services using the local development environment. It uses [local cloud](https://localstack.cloud/) with DynamoDB and S3 included.
