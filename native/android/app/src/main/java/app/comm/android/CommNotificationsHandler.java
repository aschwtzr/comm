...
public class CommNotificationsHandler extends RNFirebaseMessagingService {
  ...
  public void onMessageReceived(RemoteMessage message) {
    ...
    String rawMessageInfoString = message.getData().get(MESSAGE_INFOS_KEY);
    File sqliteFilePath =
        this.getApplicationContext().getDatabasePath("comm.sqlite");
    if (rawMessageInfoString != null && sqliteFilePath.exists()) {
      MessageOperationsUtilities.storeNotification(
          sqliteFilePath.toString(), rawMessageInfoString);
    } else if (rawMessageInfoString != null) {
