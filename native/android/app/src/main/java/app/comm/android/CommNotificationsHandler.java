    ...
    if (rawMessageInfo != null) {
      ...
      if (sqliteFilePath.exists()) {
        MessageOperationsUtilities.storeNotification(
            sqliteFilePath.toString(), rawMessageInfo);
      } else {
